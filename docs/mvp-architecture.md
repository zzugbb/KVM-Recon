...
采集侧代码已收口，见 `docs/development-plan.md` 第 22 节。架构上不再规划 Adapter 生成器、在线分析或 MITM。真机验收与 Apple/微软付费代码签名延后。安装包由 GitHub Actions 构建：macOS 为 ad-hoc 签名，Windows 无 Authenticode，见 `docs/releasing.md`。
