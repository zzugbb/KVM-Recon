...
> **历史文档（0.2.10 已发布安装包）。** 主分支已进入 0.3.0 开发（单作业、自由文本设备说明、自动收尾、手动导出、不脱敏），0.2.x 安装包不再从主分支构建。已安装的 0.2.x 现场使用仍按本文；0.3.0 的目标流程见 [`v0.3-development-spec.md`](v0.3-development-spec.md)，发布时会重写现场使用说明。
